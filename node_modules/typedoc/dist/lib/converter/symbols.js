...
function convertVariable(context, symbol, nameOverride) {
    ...
    reflection.type = context.converter.convertType(context.withScope(reflection), typeNode !== null && typeNode !== void 0 ? typeNode : context.checker.getTypeOfSymbolAtLocation(symbol, declaration));
    setModifiers(declaration, reflection);
