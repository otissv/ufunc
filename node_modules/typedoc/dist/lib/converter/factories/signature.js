...
function convertParameters(context, sigRef, parameters, parameterNodes) {
    return parameters.map((param, i) => {
        ...
        paramRefl.type = context.converter.convertType(context.withScope(paramRefl), context.checker.getTypeOfSymbolAtLocation(param, declaration));
        ...
        paramRefl.setFlag(models_1.ReflectionFlag.Rest, ts.isParameter(declaration)
